...
Surface::Surface(const HINSTANCE instance, const Dimension dimension) :
   ...
   m_windowHandle(CreateWindowExA(WS_EX_CLIENTEDGE, g_windowClassName, "Triglav Engine",
                                      WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, m_dimension.width, m_dimension.height, nullptr,
