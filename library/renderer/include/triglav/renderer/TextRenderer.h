...
class TextRenderer
{
 public:
   ...
   void update_text_object(const render_core::GlyphAtlas &atlas, TextObject &object,
                           std::string_view text) const;
   void draw_text_object(const graphics_api::CommandList &cmdList, const graphics_api::Resolution &resolution,
                         const TextObject &textObj, glm::vec2 position, glm::vec3 color) const;
