...
PostProcessing::PostProcessing(graphics_api::Device& device, resource::ResourceManager &resourceManager, graphics_api::RenderTarget &renderTarget, std::vector<graphics_api::Framebuffer> &framebuffers) :
