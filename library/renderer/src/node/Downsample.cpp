...
{
   m_downsampledTexture.emplace(GAPI_CHECK(
           m_device.create_texture(GAPI_FORMAT(RGBA, Float16), {resolution.width / 2, resolution.height / 2},
                                   TextureUsage::TransferDst | TextureUsage::Sampled)));
}
...
void Downsample::record_commands(FrameResources &frameResources, NodeFrameResources &resources,
                                 CommandList &cmdList)
{
